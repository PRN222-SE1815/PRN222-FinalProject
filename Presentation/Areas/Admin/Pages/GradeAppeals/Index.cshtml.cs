...
namespace Presentation.Areas.Admin.Pages.GradeAppeals;
...
public class IndexModel : PageModel
{
    ...
    public IndexModel(IGradeAppealService appealService, ILogger<IndexModel> logger)
    {
    ...
    public async Task<IActionResult> OnGetAsync(CancellationToken ct)
    {
        ...
        {
            _logger.LogError(ex, "Error loading admin grade appeals");
